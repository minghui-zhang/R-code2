...
# Note: we use demise_AA_25_persiann because we use A!_2.5_persiann to make predictions
...
ggplot(data = plant_delay_days_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(plant_delay_days_predicted$value, 1)), size = 5) + # write the values
...
ggplot(data = plant_delay_percent_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(plant_delay_percent_predicted$value, 1)), size = 5) + # write the values
...
ggplot(data = DC_not_possible_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(DC_not_possible_predicted$value, 1)), size = 5) + # write the values
  scale_fill_gradient2(name = "Percent", low = "white", high = "red") +
...
ggplot(data = plant_window_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(plant_window_predicted$value, 1)), size = 5) + # write the values
...
ggplot(data = delta_onset_likelihood_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(delta_onset_likelihood_predicted$value, 1)), size = 5) + # write the values
