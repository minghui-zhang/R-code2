...
```{r}
onset_type <- 'freq_5_persiann' #''AA_25_chirps_ATgabriel25km' # 'Gabriel_onset'
grid_size <- 0.75 # 0.5 for 5 km onset, 0.75 for 25 km onset
precip_data <- 'persiann'
onset_def_type <- 'freq'
thres <- '5' # keep as string; some will have two or four thres
onset_scale <- '25km_persiann' # 5km_chirps, 25km_Gabriel, 25km_persiann, 25km_chirps
