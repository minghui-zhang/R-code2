...
# get 10th, 50th percentile demise, and for those years, get the onset percentile
...
nw_onset_demise_pairing <- rbind(data.frame(demise_percentile = 50, 
                                            onset_percentile = nw_medDemise_onsetPer),
                                 data.frame(demise_percentile = 10, 
...
ne_onset_demise_pairing <- rbind(data.frame(demise_percentile = 50, 
