...
ggplot(data = delta_onset_touching5thpercentile_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(delta_onset_touching5thpercentile_predicted$value, 1))) + # write the values
...
ggplot(data = delta_onset_likelihood_predicted, mapping = aes(x = xID, y = yID, fill = value)) +
  geom_tile() +
  geom_text(aes(label = round(delta_onset_likelihood_predicted$value, 1))) + # write the values
