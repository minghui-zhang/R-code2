...
ggplot(results_AA_25, aes(x = plant_stat_type, y = onset_coef, col = onset_type)) +
...
onset_oi <- 'freq_10_persiann'
onset_baseline <- 'AA_25_persiann' # to compare to onset_oi in difference maps, etc
...
ggplot(onset_data_summarized_eachyear) +
  ...
  ggtitle('Spatial variability over the years') +
  labs(x = 'year') +
  ylim(0, 15) +
  theme_bw()
