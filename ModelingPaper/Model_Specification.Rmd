...
onset_type <- 'AA_25_persiann' #'freq_8_chirps_ATchirps5km' #'AA_25_chirps_ATchirps5km', 'freq_10_persiann'# 'Gabriel_onset'
...
diff_intensities_percentile75 <- t.test(onset_coefs_list[['SC_percentile75']], onset_coefs_list[['DC_percentile75']])$p.value
diff_intensities_percentile95 <- t.test(onset_coefs_list[['SC_percentile95']], onset_coefs_list[['DC_percentile95']])$p.value
...
diff_percentile50_75_SC <- t.test(onset_coefs_list[['SC_median']], onset_coefs_list[['SC_percentile75']])$p.value
diff_percentile50_75_DC <- t.test(onset_coefs_list[['DC_median']], onset_coefs_list[['DC_percentile75']])$p.value

diff_percentile75_95_SC <- t.test(onset_coefs_list[['SC_percentile75']], onset_coefs_list[['SC_percentile95']])$p.value
diff_percentile75_95_DC <- t.test(onset_coefs_list[['DC_percentile75']], onset_coefs_list[['DC_percentile95']])$p.value
